...
public class GlobalExceptionHandler {
    ...
    /**
     * Xử lý lỗi thiếu tồn kho khi xuất thuốc (Insufficient Stock - 400)
     */
    ...
    /**
     * Xử lý lỗi sai trạng thái đơn thuốc (Invalid State - 400)
     */
    @ExceptionHandler(InvalidPrescriptionStateException.class)
    public ResponseEntity<ApiResponse<Void>> handleInvalidPrescriptionStateException(InvalidPrescriptionStateException ex) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(ApiResponse.error(HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }
    ...
    /**
     * Xử lý lỗi endpoint / tài nguyên không tồn tại (NoResourceFoundException)
     */
