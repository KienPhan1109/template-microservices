...
import com.ptit.medicare_medical_service.validator.UniqueRecordCode;
...
public class MedicalCreateRequest {
    ...
    @Size(max = 30, message = "Mã hồ sơ bệnh án không được vượt quá 30 ký tự")
    @UniqueRecordCode
    ...
    @NotBlank(message = "Chẩn đoán kết luận không được để trống")
