...
public class GlobalExceptionHandler {
    ...
    /**
     * Xử lý lỗi sai định dạng JSON (Malformed JSON, Enum không hợp lệ, parse lỗi)
     */
    ...
    /**
     * Xử lý lỗi chuyên khoa không hợp lệ (Invalid Department - 400)
     */
    @ExceptionHandler(InvalidDepartmentException.class)
    public ResponseEntity<ApiResponse<Void>> handleInvalidDepartmentException(InvalidDepartmentException ex) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
    ...
    /**
     * Xử lý lỗi đối số không hợp lệ (Bad Argument - 400)
     */
